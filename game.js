...
Game.prototype.init = function() {
  this.exponentTrainer = new ExponentTrainer(this.STAGE_WIDTH, this.STAGE_HEIGHT, this.stage);
  this.exponentTrainer.init()
}
...
Game.prototype.update = function (pEvent) {
    ...
    if (this.exponentTrainer) {
      this.exponentTrainer.update();
    }
